...
sudo apt -y install wget curl vim rofi gnome-session gnome-shell-extensions font-manager papirus-icon-theme libreoffice vlc google-chrome-stable zoom telegram-desktop zsh
